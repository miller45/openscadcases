...
knob_radius_top = 7;
knob_radius_bottom = 8;
knob_height = 16;
knob_smoothness = 20;

outer_shaft=true;
outer_shaft_radius = 3.75;
outer_shaft_height = 2.5;
outer_shaft_smoothness = 40;

shaft_radius = 2.1;
shaft_height = 14;
shaft_smoothness = 40;

outer_shaft_is_flatted = false;
...
flat_size = 5.8 + flat_size_adjustment;
...
module outer_shaft_hole() {
				...
				difference()
					...
					// round shaft hole
					translate([ 0, 0, -1 ]) 
					cylinder(r=outer_shaft_radius,h=outer_shaft_height, $fn=outer_shaft_smoothness);
					
					if(outer_shaft_is_flatted == true)
						{
